...
<body style="background: #E9FFFF">
        <div>
            <header class="header w3-card w3-center w3-padding-32">
                <div style="font-size: 225%; font-weight: bold"><i class="fa fa-graduation-cap"></i> MyTutor</div><br />
        ...
        <div class="w3-container w3-padding-32" style="margin: 0 auto; padding-left: 64px; padding-right: 64px; word-wrap: keep-all">
            ...
            <p>Your privacy is important to us. It is MyTutor&#39;s policy to respect your privacy and comply with any applicable law and regulation regarding any personal information we may collect about you, including across our website, <a href="http://localhost:8000">http://localhost:8000/</a>, and other sites we own and operate. </p>
            <p>This policy is effective as of 6 June 2022 and was last updated on 6 June 2022. </p>
            ...
            <p>Deborah N<br />
            deborah_nazarena_@soc.uum.edu.my </p>
        </div>
