...
-- Dumping database structure for mytutor_laravel
CREATE DATABASE IF NOT EXISTS `mytutor_laravel` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;
USE `mytutor_laravel`;
...
CREATE TABLE IF NOT EXISTS `subjects` (
  ...
  `subject_description` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `subject_price` double(8,2) NOT NULL,
  `subject_total_learning_hours` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `tutors` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `tutors_email_unique` (`email`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Data exporting was unselected.

-- Dumping structure for table mytutor_laravel.users
